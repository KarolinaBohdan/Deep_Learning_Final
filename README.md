...
1️⃣ Baseline classifier + uncertainty sampling
2️⃣ Human-in-the-loop correction of uncertain samples
3️⃣ QLoRA fine-tuning of a large language model
4️⃣ Multi-Agent reasoning for final classification
...
is_green_silver	weak (silver) label
split	dataset split
Dataset splits:
Split	Size	Purpose
...
4️⃣ Run the Multi-Agent System
python mas_final.py
